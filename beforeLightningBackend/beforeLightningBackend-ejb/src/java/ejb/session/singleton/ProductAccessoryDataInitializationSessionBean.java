...
//                p2.setImageLink("ghost17x.png");
        ...
        ReviewEntity review1 = new ReviewEntity("Jackson", 5, "I love this product, it has been a game changer and i will recommend it to anyone!");
        ReviewEntity review2 = new ReviewEntity("Ambrose", 5, "Good mouse, will buy again when i need it again next time");
        ReviewEntity review3 = new ReviewEntity("Dr Strange", 3, "Not really that good, was really hyped but i guess its okay");
        ReviewEntity review4 = new ReviewEntity("Abigail", 5, "I have been missing this from my life for too long... THANKS BEFORELIGHTNING!!!");
        ReviewEntity review5 = new ReviewEntity("Gina Choo", 4, "Great Product!");
        ReviewEntity review6 = new ReviewEntity("Damien Tan", 2, "Did not like this Product at all...");
        ReviewEntity review7 = new ReviewEntity("Harry Chia", 4, "Very good quality!! Am really impressed with it and will get it again next time");
        ReviewEntity review8 = new ReviewEntity("Tan Su Lee", 5, "It works really well and makes my life so much better!");
        ...
        try {
            ...
            product1.setImageLink("beast15S.png");
            product2.setImageLink("ghost17x.png");
            PartChoiceEntity chassisPC1 = partChoiceEntitySessionBeanLocal.retrievePartChoiceEntityByPartChoiceName(product1.getProductName() + " Chassis");
            chassisPC1.setImageLink("beast15S.png");
            PartChoiceEntity chassisPC2 = partChoiceEntitySessionBeanLocal.retrievePartChoiceEntityByPartChoiceName(product2.getProductName() + " Chassis");
            chassisPC2.setImageLink("ghost17x.png");
            ...
            partChoiceA1.setImageLink("intelI5-12500H.png");
            partChoiceA2.setImageLink("intelI7-12700H.png");

            partChoiceB1.setImageLink("nvidiaRTX3050.png");
            partChoiceB2.setImageLink("nvidiaRTX3050Ti.png");

            partChoiceC1.setImageLink("8gbRam.png");
            partChoiceC2.setImageLink("16gbRam.png");
            partChoiceC3.setImageLink("32gbRam.png");

            partChoiceD1.setImageLink("stockThermalCompound.png");
            partChoiceD2.setImageLink("premiumThermalCompound.png");

            partChoiceE1.setImageLink("noOperatingSystem.png");
            partChoiceE2.setImageLink("windows10Home.png");
            partChoiceE3.setImageLink("windows10Professional.png");
            partChoiceE4.setImageLink("windows11Home.png");
            partChoiceE5.setImageLink("windows11Professional.png");
            ...
            mouse1.setImageLink("logitechPro910.png");
            mouse2.setImageLink("logitechG305.png");
            mouse3.setImageLink("corsairSabreRGB.png");

            speaker1.setImageLink("kefLS50Meta.png");
            speaker2.setImageLink("creativePebbleV3.png");
            speaker3.setImageLink("elacDebut.png");

            reviewEntitySessionBeanLocal.createNewReviewEntityForAcc(review1, mouse1.getAccessoryItemEntityId());
            reviewEntitySessionBeanLocal.createNewReviewEntityForAcc(review2, mouse2.getAccessoryItemEntityId());
            reviewEntitySessionBeanLocal.createNewReviewEntityForAcc(review3, mouse2.getAccessoryItemEntityId());
            ...
            reviewEntitySessionBeanLocal.createNewReviewEntityForProduct(review7, product1.getProductEntityId());
            ...
            reviewEntitySessionBeanLocal.createNewReviewEntityForProduct(review8, product2.getProductEntityId());

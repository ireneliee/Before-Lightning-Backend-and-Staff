 ...
 * @author Koh Wen Jie
 */
@Named(value = "updateWebsiteAccessoryItemManagedBean")
@ViewScoped
public class UpdateWebsiteAccessoryItemManagedBean implements Serializable {
    ...
    /**
     * Creates a new instance of UpdateWebsiteAccessoryItemManagedBean
     */
    public UpdateWebsiteAccessoryItemManagedBean() {
    }

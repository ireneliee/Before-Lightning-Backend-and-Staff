 ...
 * @author Koh Wen Jie
 */
@Named(value = "updateWebsitePartChoiceManagedBean")
@ViewScoped
public class UpdateWebsitePartChoiceManagedBean implements Serializable {
    ...
    /**
     * Creates a new instance of UpdateWebsitePartChoiceManagedBean
     */
    public UpdateWebsitePartChoiceManagedBean() {
    }

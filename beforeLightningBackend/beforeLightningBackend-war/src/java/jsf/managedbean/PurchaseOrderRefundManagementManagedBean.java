 ...
 * @author srinivas
 */
@Named(value = "purchaseOrderRefundManagementManagedBean")
@ViewScoped
public class PurchaseOrderRefundManagementManagedBean implements Serializable {
     ...
     */
    public PurchaseOrderRefundManagementManagedBean() {
    }
    
    @PostConstruct
    public void postConstruct() {
        setListOfAllPurchaseOrders(purchaseOrderEntitySessionBean.retrieveRefundedAllPurchaseOrders());

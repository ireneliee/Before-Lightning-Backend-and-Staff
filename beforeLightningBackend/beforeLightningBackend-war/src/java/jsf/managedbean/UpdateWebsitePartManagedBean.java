 ...
 * @author Koh Wen Jie
 */
@Named(value = "updateWebsitePartManagedBean")
@ViewScoped
public class UpdateWebsitePartManagedBean implements Serializable {
    ...
    /**
     * Creates a new instance of UpdateWebsitePartManagedBean
     */
    public UpdateWebsitePartManagedBean() {
    }

 ...
 * @author srinivas
 */
@Named(value = "purchaseOrderCompleteManagementManagedBean")
@ViewScoped
public class PurchaseOrderCompleteManagementManagedBean implements Serializable {
     ...
     */
    public PurchaseOrderCompleteManagementManagedBean() {
    }
    
    @PostConstruct
    public void postConstruct() {
        setListOfAllPurchaseOrders(purchaseOrderEntitySessionBean.retrieveCompletedAllPurchaseOrders());

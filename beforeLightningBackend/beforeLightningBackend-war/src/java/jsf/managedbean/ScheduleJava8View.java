...
public class ScheduleJava8View implements Serializable {
    ...
    public void init() {
        ...
        event = DefaultScheduleEvent.builder()
                .title("Meeting with Manager B")
                .startDate(today1Pm())
                .endDate(today6Pm())
                .description("Prep proposal")
                .overlapAllowed(true)
                .build();
        eventModel.addEvent(event);

        event = DefaultScheduleEvent.builder()
                .title("Meeting with Manager C")
    ...
    public void addEvent() {
        ...
        if (event.getId() == null) {
            eventModel.addEvent(event);
            FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_INFO, "Event added", "Please be reminded that event is going to disappear upon logout.");
    ...
    public void onEventMove(ScheduleEntryMoveEvent event) {
        FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_INFO, "Event moved", "Please be reminded that event is going to disappear upon logout.");

        addMessage(message);
    }

    public void onEventResize(ScheduleEntryResizeEvent event) {
        FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_INFO, "Event resized", "Please be reminded that event is going to disappear upon logout.");

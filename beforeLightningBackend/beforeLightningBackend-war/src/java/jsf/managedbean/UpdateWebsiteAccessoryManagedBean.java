 ...
 * @author Koh Wen Jie
 */
@Named(value = "updateWebsiteAccessoryManagedBean")
@ViewScoped
public class UpdateWebsiteAccessoryManagedBean implements Serializable {
    ...
    /**
     * Creates a new instance of UpdateWebsiteAccessoryManagedBean
     */
    public UpdateWebsiteAccessoryManagedBean() {
    }
